...
void setup() {
  ...
  Serial.println("Programa comenzando");
  Serial.println("Han pasado los primeros 10 segundos");
  delay(10000);

  Serial.println("Han pasado los segundos 10 segundos, programa por comenzar");
  delay(10000);
